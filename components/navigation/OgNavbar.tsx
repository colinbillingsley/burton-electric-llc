...
const OgNavbar = () => {
  ...
  return (
    <nav
      className={`p-3 sticky top-0 left-0 w-full z-50 border-b-2 border-primary transition-all duration-200 shadow-md flex items-center justify-between ${
        scrolled
          ? "bg-white/85 backdrop-blur-xl shadow-transparent"
