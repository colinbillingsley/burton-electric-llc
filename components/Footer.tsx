  ...
  return (
    <footer className="py-24 lg:py-32 px-8 bg-secondary">
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="grid grid-cols-1 gap-4 md:gap-0">
          <div className="flex items-start gap-4">
            ...
            <div className="text-white space-y-2">
              <p className="font-bold text-lg">Burton Electric</p>
              <span className="text-muted-foreground text-sm font-medium">
                Family-run electrical service in Nashville, TN and surrounding
                areas for shops, offices homes, and large commercial spaces.
              </span>
            </div>
          </div>
        ...
        <div className="text-white space-y-2">
          ...
          <ul className="flex flex-col gap-1 text-sm text-muted-foreground">
            ...
            <li>
              <Link href="/about-us" className="hover:text-primary font-medium">
                About Us
              </Link>
            </li>
            <li>
              <Link href="/faq" className="hover:text-primary font-medium">
                FAQ
              </Link>
            </li>
            <li>
        ...
        <div className="text-white space-y-2 font-medium">
      ...
      <div className="flex items-center justify-between text-base font-medium text-muted-foreground border-t border-muted/10 mt-12 p-4">
        ...
        <span>Commerical + Residential</span>
      </div>
    </footer>
  );
};
