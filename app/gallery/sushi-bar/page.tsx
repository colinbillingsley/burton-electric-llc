...
export const metadata: Metadata = {
	title: "Gallery of The Sushi Bar | Burton Electric LLC",
	description:
		"Images from the The Sushi Bar project in Nashville, TN by Burton Electric LLC.",
	icons: {
...
const page = () => {
	return (
		<PageContainer>
			<MainContainer>
				<H1>
					<Important>The Sushi Bar</Important>
				</H1>
