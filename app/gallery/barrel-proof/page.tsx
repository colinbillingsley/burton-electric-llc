...
export const metadata: Metadata = {
	title: "Gallery of Eggspectation | Burton Electric LLC",
	description:
		"Images from the Eggspectation project in Nashville, TN by Burton Electric LLC.",
	icons: {
...
const page = () => {
	return (
		<PageContainer>
			<MainContainer>
				<H1>
					<Important>Barrel Proof</Important>
				</H1>

				<P className="text-muted-foreground my-5">
					A look at the Barrel Proof project we completed in Nashville, TN.
				</P>
