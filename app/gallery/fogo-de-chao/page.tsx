...
export const metadata: Metadata = {
	title: "Gallery of Fogo de Chão | Burton Electric LLC",
	description:
		"Images from the Fogo de Chão project in Nashville, TN by Burton Electric LLC.",
	icons: {
...
const page = () => {
	return (
		<PageContainer>
			<MainContainer>
				<H1>
					<Important>Fogo de Chão</Important>
				</H1>

				<P className="text-muted-foreground my-5">
					A look at the Fogo de Chão project we completed in Nashville, TN.
				</P>

				<ProjectImages images={mainProjects[0].images} />
