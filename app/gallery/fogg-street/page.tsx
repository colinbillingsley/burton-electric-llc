...
export const metadata: Metadata = {
	title: "Gallery of Fogg Street | Burton Electric LLC",
	description:
		"Images from the Fogg Street project in Nashville, TN by Burton Electric LLC.",
	icons: {
...
const page = () => {
	return (
		<PageContainer>
			<MainContainer>
				<H1>
					<Important>Fogg Street</Important>
				</H1>

				<P className="text-muted-foreground my-5">
					A look at the Fogg Street project we completed in Nashville, TN.
				</P>
