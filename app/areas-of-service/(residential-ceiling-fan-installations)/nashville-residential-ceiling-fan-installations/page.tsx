...
const page = () => {
	return (
		<PageContainer>
			<MainContainer>
				<H1>
					<Important>Nashville Residential Ceiling Fan Installations</Important>
				</H1>
				...
				<Section spacing="small">
					<P>
						...
						Ceiling fans are, by and large, heavy and cumbersome. Climbing up on
						your ladder with your new ceiling fan in-hand and trying to figure
						out how to wire it is a recipe for disaster.
					</P>
					<P>
				...
				<Section spacing="small">
					...
					<P>
						If you are in the market for a new ceiling fan, you are most likely
						interested in staying cool throughout the summer months. But ceiling
						fans can do a lot more than keep you comfortable when the Nashville
						summer starts heating up. Some of the best reasons to install a
						ceiling fan in your home include:
					</P>
					...
					<div className="grid md:grid-cols-2 gap-4">
						...
						<div className="p-4 space-y-4 border-2 border-muted bg-white shadow-md rounded-sm">
							...
							<P className="text-muted-foreground">
								...
								heavy machinery in your home to do all the heating and cooling,
								let a ceiling fan make the fine-tuned adjustments for you.
							</P>
						</div>
						<div className="p-4 space-y-4 border-2 border-muted bg-white shadow-md rounded-sm">
							<Lightbulb
				...
				<Section spacing="small">
					...
					<P>
						There are several electrical companies in the Nashville area, so why
						choose us? Well, when you decide to work with Burton Electric LLC,
						you are guaranteed to have access to highly trained, licensed and
						insured professionals. What sets us apart from the competition is
						our dedication to safety, energy efficiency and always providing
						reliable service.
					</P>
				</Section>
				...
				<ContactUs>
					...
					<ContactContent>
						For residential ceiling fan installations with guaranteed results,
