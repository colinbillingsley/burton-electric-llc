	...
	return (
		<PageContainer>
			<SlideInFromLeft amount={0}>
				<CenterDiv>
					<PageHeading>
						<p>Landscape Lighting Services</p>
					</PageHeading>
					...
					>
						<div className="space-y-4">
							<p>
								...
								landscape can do for your commercial or residential property,
								but are you getting all that you can out your landscape if
								it&apos;s not properly lit? We regret to inform you that if you
								haven&apos;t invested in landscape lighting, only half of your
								landscape&apos;s value-boosting potential has been tapped.
							</p>

							<p>
								There are a ton of benefits you can expect to reap once you
								invest in landscape lighting, namely safety and security. When
								your commercial or residential property is covered in darkness,
								the chances of someone missing a step or tripping over something
								decorative and hurting themselves is high. Providing visitors
								and residents with the necessary light to see their surroundings
								...
								any potential hiding spots, you can deter people from
								trespassing or loitering on your property.
							</p>
						</div>

						<div className="space-y-4">
							<p>
								Now, these are obviously two very practical benefits of
								investing in landscape lighting, but don&apos;t forget the
								esthetic value outdoor lighting can add. There are a number of
								different lighting techniques that can be applied to your
								property to create a nighttime scene that looks like it should
								be on a canvas in a museum rather than exist in real life.
							</p>
							<p>
								...
								systems. If you want to work with landscape lighting experts
								that are both affordable and highly recommended by commercial
								and residential clients all over the area, get in touch with
								Burton Electric LLC today.
							</p>
							<p>
								Burton Electric LLC has completed hundreds of outdoor lighting
								installations and we are ready to start collaborating on a
								design to perfectly accent your home or business today.
							</p>
						</div>
					</Section>
					...
					<Section my="sm" className="space-y-2">
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-8">
							<div className="h-full p-8 space-y-4 bg-gradient-to-br from-white to-gray-50 border text-secondary rounded-lg shadow-lg">
								<span className="text-2xl font-medium block text-emerald-500">
									Do:
								</span>
								<ul className="space-y-3">
									{dos.map((dos, index) => (
										<li key={`do-${index}`} className="flex items-start gap-3">
											...
											/>
											<p className="text-sm">{dos.desc}</p>
										</li>
									))}
								</ul>
							</div>
			...
			<ContactUs desc="Getting your outdoor lighting perfect is about as difficult to do as wiring it all yourself. So, spare yourself the headache and let Burton Electric LLC's experts design, install and maintain your residential or commercial property's landscape lighting." />
		</PageContainer>
	);
};
