...
const pages = () => {
	return (
		<PageContainer>
			<MainContainer>
				<H1>
					<Important>Security Lighting Services</Important>
				</H1>

				<Section spacing="small" className="grid md:grid-cols-2 gap-8">
					<P>
						Is your home or business adequately protected against intruders and
						vandals? If you don&apos;t have a professionally installed security
						lighting system in place, you might want to think about it for a
						while before you answer the question. Even if your home or business
						is equipped with a state-of-the-art security system, strategically
						placed, motion sensor lights can go a long way in detecting and
						deterring any potential threats. It can also make concealment a
						challenge, increasing the chances that the perpetrators get caught
						and brought to justice.
					</P>
					<div className="space-y-6">
						<P>
							If you are ready to increase your home or business&apos;s security
							at an affordable rate, then give Burton Electric LLC a call today.
							Our team of licensed and insured electricians have been installing
							residential and commercial security lighting systems all over the
							area for many years. When we are tasked with increasing a home or
							business&apos;s security, we take it very seriously. Burton
							Electric LLC is proud to be known for our quality work, but we
							take extra special care with security lighting systems because you
				...
				<Section className="grid md:grid-cols-2 gap-8">
					<div className="space-y-6">
						...
						<P>
							...
							detract from their property&apos;s curb appeal. If you are in this
							camp, you should know that when Burton Electric LLC installs
							security lighting, it&apos;s not going to give your home a
						...
						<P>
							...
							mutually exclusive, especially when you work with electricians who
							have an abundance of experience designing lighting systems that do
							both.
						</P>
						<P>
				...
				<ContactUs>
					...
					<ContactContent>
						Increasing your home or business&apos;s security is as simple as
