          ...
          {services.map((service, index) => (
            <div key={index} className="group h-full">
              <div className="h-full bg-white border-2 border-gray-100 rounded-2xl p-8 hover:border-primary/25 hover:shadow-xl transition-all duration-300">
                <div className="bg-primary/10 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 group-hover:bg-primary transition-all duration-300">
                ...
                <div className="space-y-3">
                  {service.features.map((feature, idx) => (
                    <div key={idx} className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-primary mr-3 flex-shrink-0" />
